...
Your task is to handle Phase 1 of the unified operation flow:
  ...
  1. Research: Perform semantic search (using .agents/skills/obsidian-rag-retrieve/SKILL.md) in the Obsidian KB and fact-check factual/domain-specific details.
